...
namespace Unity.Entities.Unsafe
{
    ...
    {
        [FieldOffset(ArchetypeOffsets._0136_ComponentTypeInArchetypePtr_Types_8)]
        [NativeDisableUnsafePtrRestriction]
        public int* Types;

        [FieldOffset(ArchetypeOffsets._0144_Int32_TypesCount_4)]
        public int TypesCount;

        [FieldOffset(ArchetypeOffsets._0148_Int32_NonZeroSizedTypesCount_4)]
        public int NonZeroSizedTypesCount;

        [FieldOffset(ArchetypeOffsets._0152_Int32Ptr_Offsets_8)]
        [NativeDisableUnsafePtrRestriction]
        public int* Offsets;

        [FieldOffset(ArchetypeOffsets._0160_Int32Ptr_SizeOfs_8)]
        [NativeDisableUnsafePtrRestriction]
        public int* SizeOfs;

        [FieldOffset(ArchetypeOffsets._0168_Int32Ptr_BufferCapacities_8)]
        [NativeDisableUnsafePtrRestriction]
